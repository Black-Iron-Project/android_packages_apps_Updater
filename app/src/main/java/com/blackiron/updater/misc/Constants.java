...
public final class Constants {
    ...
    public static final String PROP_DEVICE = "ro.blackiron.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "blackiron.updater.allow_downgrading";
